 ...
 */
 ...
 /*:ja
 * @plugindesc プレイヤーが特定のリージョンIDを踏んだ際に、指定のコモンイベントを発動させます。
 * @author Yanfly Engine Plugins
 *
 * @param Region 1
 * @desc このリージョンを踏んだ際に再生されるコモンイベントを指定します。不要な場合は0を入力します。
 * @default 0
 *
 * @param Region 2
 * @desc このリージョンを踏んだ際に再生されるコモンイベントを指定します。不要な場合は0を入力します。
 ...
 * ============================================================================
 *
 * マップ上には、255のリージョンがあります。
 * パラメータ内のリージョン番号に、イベントのIDを紐づけることで、
 * プレイヤーがリージョンを踏むたびに、コモンイベントを再生させることができます。
 * 特定のリージョンIDをもったタイルをトリガーにして、
 * タッチイベントを呼び出すことができます。
 *
 * タッチインプット中にコモンイベントが起こった場合は、
 * ゲームエンジンによりタッチインプットは無効化されることに気を付けてください。
 *
 * ============================================================================
 * Notetags
 * ============================================================================
 *
 * マップ内でこのNotetagを使用することができます。
 *
 * Map Notetags:
 *   <Region x Event: y>
 *   プレイヤーがリージョン x を踏んだ時 y というコモンイベントを呼び出します。
 *   これはエディタのデフォルト設定を上書きします。
 * 
 */
