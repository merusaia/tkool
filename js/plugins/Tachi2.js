 ...
 * 
 * 【プラグインコマンド】
 * スキップモード、という、早送りとは別の、ゲームを一瞬で過ぎさせる機能をつけようとしていますが、まだ出来ていません…。
 * 誰か、ゲーム中の「ウェイト」を倍速で過ぎさせる方法を、おしえてください・・・m(__)m
 *
...
Game_System.prototype.plugin_Tachi_edit_SkipModeOn = function(){
    ...
    // ここにスキップモード時に必要な処理を追加（まだ出来ていません・・）
}
