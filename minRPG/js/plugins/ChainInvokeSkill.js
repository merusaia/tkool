...
Imported['ChainInvokeSkill'] = 1.01;

/*:
 * @plugindesc ver1.01b/特定の組み合わせでスキルを使用することで、追加でスキルを発動させるプラグインです。
 * @author Yana
 * 
...
(function(){
	...
	Game_Battler.prototype.setChainAction = function(target) {
		...
		if (!this._chainActions[id]){ this._chainActions[id] = {} }
	...
	Game_Battler.prototype.currentChainAction = function() {
		...
		if (this._currentActionKey === undefined){
			for (var i=0,max=this._chainActions.length;i<max;i++){
