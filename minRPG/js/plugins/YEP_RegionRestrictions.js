...
/*:ja
 * @plugindesc リージョンを用いて、イベントおよびプレイヤーの移動制限を行います。
 * @author Yanfly Engine Plugins
 *
 * @param Player Restrict
 ...
 * ============================================================================
 *
 *このプラグインでは、リージョンIDによってマークされたタイルを用いることで
 * NPCの行動範囲を制限することが出来ます。
 * 任意の範囲を描いて指定することで、NPCをその範囲内に留めることができます。
 * 同様に、プレイヤーに対しても行動範囲の制限を設けることもできます。
 * 
 * RPGツクールVX Aceからの新しい変更として、
 * プレイヤーとイベントがいつでも行き来できるリージョンが登場しました。
 * 
 */
//=============================================================================
